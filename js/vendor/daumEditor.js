...
function saveContent() {
	...
	if(files != null){
		for (i = 0; i < files.length; i++) {
			...
			var ElementModifyName = "<input type='hidden' name='modifyname"+i+"' value='"+files[i].data.modifyname+"' >";
			document.getElementById('tx_editor_form').insertAdjacentHTML('beforeEnd',ElementModifyName);
